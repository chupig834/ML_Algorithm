...
def train_model(X_train, t_train, max_depth = 10, min_samples_leaf = 10, criterion = 'gini', 
                seed = 60, model_type = 'DT', n_estimators = 50, max_samples = 0.5, max_features = None):
  '''
  Inputs: 
  ...
  #Random Forest: TODO (call RandomForestClassifier with appropriate parameters)
    ...
    model = RandomForestClassifier(n_estimators=n_estimators, criterion=criterion, max_depth = max_depth, min_samples_leaf=min_samples_leaf, max_features=max_features,
                                    random_state=seed, max_samples=max_samples)
